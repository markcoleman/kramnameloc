...
summary: "Visual Studio Online and TFS makes this process easy."
...
![Illustration from Load Testing In The Cloud (1)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/03-03-solutionview_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (2)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/04-04-addrecording_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (3)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/05-05-recordingview_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (4)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/06-06-recordingoutput_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (5)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/07-07-runninglocal_large.png' | relative_url }})

#Create Load Test
####Add LoadTest
Now that we see the webtest is validated we need to add a "Load Test".  This is done by adding a new file to your project.
![Illustration from Load Testing In The Cloud (6)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/08-08-add-load-test_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (7)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/09-09-load-test-dialog_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (8)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/10-10-change-step-load_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (9)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/11-11-add-web-test_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (10)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/12-12-duration_large.png' | relative_url }})

####Load Test
After you have all the settings changed you can see the configuration tree in the load test file inside of visual studio.
![Illustration from Load Testing In The Cloud (11)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/13-13-load-test_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (12)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/14-14-add-test-settings_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (13)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/15-15-run-tests-using-visual-studio-team-foundation-service_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (14)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/16-16-select-load-test-settings-file_large.png' | relative_url }})

#Running Your Test
####Run Load Test
We are now ready to get started by clicking on Run under "Load Test"
![Illustration from Load Testing In The Cloud (15)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/17-17-run-load-test_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (16)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/18-18-it-is-running_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (17)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/19-19-view-in-dashboard_large.png' | relative_url }})
...
![Illustration from Load Testing In The Cloud (18)]({{ '/assets/blog-images/2014-02-21-load-testing-in-the-cloud/20-20-load-results_large.png' | relative_url }})
