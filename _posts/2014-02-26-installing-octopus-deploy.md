...
summary: "Adventures in automated deployment"
...
###Welcome
![Illustration from Installing Octopus Deploy (1)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/01-01-welcome-server_large.png' | relative_url }})

###License
![Illustration from Installing Octopus Deploy (2)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/02-02-lic-server_large.png' | relative_url }})
Simply paste in the license you received via email into the text area.

###Storage
![Illustration from Installing Octopus Deploy (3)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/03-03-storage-server_large.png' | relative_url }})
I changed the value to ```D:\Octopus``` not really sure why I did this but felt like a good idea.

###Web Portal
![Illustration from Installing Octopus Deploy (4)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/04-04-portal-server_large.png' | relative_url }})
I left the default settings for the web portal since I have nothing else installed on this fresh azure vm.

###Authentication
![Illustration from Installing Octopus Deploy (5)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/05-05-auth-server_large.png' | relative_url }})
...
###Install
![Illustration from Installing Octopus Deploy (6)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/06-06-install-server_large.png' | relative_url }})
...
![Illustration from Installing Octopus Deploy (7)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/07-07-manager-server_large.png' | relative_url }})
...
###Welcome
![Illustration from Installing Octopus Deploy (8)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/08-08-welcome-tent_large.png' | relative_url }})

###Storage
![Illustration from Installing Octopus Deploy (9)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/09-09-storage-tent_large.png' | relative_url }})
...
###Communication
![Illustration from Installing Octopus Deploy (10)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/10-10-comm-tent_large.png' | relative_url }})
...
![Illustration from Installing Octopus Deploy (11)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/11-11-add-env-server_large.png' | relative_url }})
...
![Illustration from Installing Octopus Deploy (12)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/12-12-add-machine-server_large.png' | relative_url }})
...
![Illustration from Installing Octopus Deploy (13)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/13-13-add-print-tent_large.png' | relative_url }})
With the newly obtained thumbprint value I pasted the value into the tentacle configuration.

###Install
![Illustration from Installing Octopus Deploy (14)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/14-14-install-tent_large.png' | relative_url }})
Now we are able to install the tentacle configuration.

###Manager
![Illustration from Installing Octopus Deploy (15)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/15-15-manager-tent_large.png' | relative_url }})
After the configuration is applied we are displayed a similar manager screen for the tentacle.

###Back to Server
![Illustration from Installing Octopus Deploy (16)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/16-16-machine-setting-server_large.png' | relative_url }})
...
###Configured
![Illustration from Installing Octopus Deploy (17)]({{ '/assets/blog-images/2014-02-26-installing-octopus-deploy/17-17-machine-server_large.png' | relative_url }})
