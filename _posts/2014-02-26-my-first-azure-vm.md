...
###Create New VM
![Illustration from My First Azure VM (1)]({{ '/assets/blog-images/2014-02-26-my-first-azure-vm/01-new-vm-portal_large.png' | relative_url }})
...
![Illustration from My First Azure VM (2)]({{ '/assets/blog-images/2014-02-26-my-first-azure-vm/02-select-windows_large.png' | relative_url }})
Now since I wanted to create a Windows Server I selected the Windows Server Essentials image.

###Server Name and User
![Illustration from My First Azure VM (3)]({{ '/assets/blog-images/2014-02-26-my-first-azure-vm/03-server-details_large.png' | relative_url }})
...
![Illustration from My First Azure VM (4)]({{ '/assets/blog-images/2014-02-26-my-first-azure-vm/04-vm-configuration_large.png' | relative_url }})
...
###Setup Ports
![Illustration from My First Azure VM (5)]({{ '/assets/blog-images/2014-02-26-my-first-azure-vm/05-setup-ports_large.png' | relative_url }})
...
###Creating VM
![Illustration from My First Azure VM (6)]({{ '/assets/blog-images/2014-02-26-my-first-azure-vm/06-creating-your-vm_large.png' | relative_url }})
...
###It is running!
![Illustration from My First Azure VM (7)]({{ '/assets/blog-images/2014-02-26-my-first-azure-vm/07-it-is-running_large.png' | relative_url }})
