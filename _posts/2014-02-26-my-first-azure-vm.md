...
###Create New VM
![Silvrback blog image](/assets/blog-images/78b36dc0f8e3-new-vm-portal_large.png)
...
![Silvrback blog image](/assets/blog-images/551151acb766-select-windows_large.png)
Now since I wanted to create a Windows Server I selected the Windows Server Essentials image.

###Server Name and User
![Silvrback blog image](/assets/blog-images/43c94fd87b15-server-details_large.png)
...
![Silvrback blog image](/assets/blog-images/e0e60bd44335-vm-configuration_large.png)
...
###Setup Ports
![Silvrback blog image](/assets/blog-images/721adfbcda57-setup-ports_large.png)
...
###Creating VM
![Silvrback blog image](/assets/blog-images/c34b913c0720-creating-your-vm_large.png)
...
###It is running!
![Silvrback blog image](/assets/blog-images/59bcf4eceac2-it-is-running_large.png)
