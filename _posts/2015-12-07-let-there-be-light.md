...
*it glows*
![Silvrback blog image]({{ '/assets/blog-images/2015-12-07-let-there-be-light/01-img_0705_large.jpg' | relative_url }})

#Pieces
![Silvrback blog image]({{ '/assets/blog-images/2015-12-07-let-there-be-light/02-img_0702_large.jpg' | relative_url }})
...
![Silvrback blog image]({{ '/assets/blog-images/2015-12-07-let-there-be-light/03-img_0703_large.jpg' | relative_url }})
Before we go forward can we get it to light up again? And yes we can. 
![Silvrback blog image]({{ '/assets/blog-images/2015-12-07-let-there-be-light/04-img_0706_large.jpg' | relative_url }})
...
![Silvrback blog image]({{ '/assets/blog-images/2015-12-07-let-there-be-light/05-img_0707_large.jpg' | relative_url }})
...
#Results
![Silvrback blog image]({{ '/assets/blog-images/2015-12-07-let-there-be-light/06-img_3023_large.gif' | relative_url }})
